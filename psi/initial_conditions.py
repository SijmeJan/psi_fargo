...
def write_condinit_file(pd, perturbation=None):
    ...
    Args:
        pd: PolyDust object
        perturbation (optional): List of strings governing density and velocity perturbations, or None in case of no perturbations. Usually generated by Perturbation.to_string().
    '''
